...
{
	int i = 0;
	while (i < set->size && strcmp(set->ele[i], data) != 0)
	{
		i++;
	}
	if (i >= set->size)
...
void sample_linkset_test()
{
	...
	linkset_print(resu_u);
	printf("inter set1 and set2: ");
	linkset_print(resu_i);
	printf("differ set1 and set2: ");
	linkset_print(resu_d);
	printf("symdiffer set1 and set2: ");
	linkset_print(resu_s);
	printf("comple e and set2: ");
	linkset_print(resu_c);
...
void sample_arrayset_test()
{
	...
	printf("union set1 and set2: ");
	arrayset_print(resu_u);
	printf("inter set1 and set2: ");
	arrayset_print(resu_i);
	printf("differ set1 and set2: ");
	arrayset_print(resu_d);
	printf("symdiffer set1 and set2: ");
	arrayset_print(resu_s);
	printf("comple e and set2: ");
	arrayset_print(resu_c);
