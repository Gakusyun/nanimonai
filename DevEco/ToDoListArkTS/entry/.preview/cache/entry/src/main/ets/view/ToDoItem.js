...
export default class ToDoItem extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.backgroundColor({ "id": 16777233, "type": 10001, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            if (this.isComplete) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.labelIcon.bind(this)({ "id": 16777223, "type": 20000, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
                });
            }
            else {
